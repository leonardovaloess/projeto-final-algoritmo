...
top_frame = ctk.CTkFrame(janela_principal)
...
botao_editar_produto = ctk.CTkButton(top_frame, text="Editar Produto", width=100)
...
botao_deletar_produto = ctk.CTkButton(top_frame, text="Deletar Produto", command=deletar_produto, width=20)
...
# Botão para sair
botao_sair = ctk.CTkButton(top_frame, text="Sair", command=janela_principal.destroy, width=120)
